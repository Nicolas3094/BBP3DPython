import numpy as np
from numba import float32,types, typed, int64,njit,deferred_type
from numba.experimental import jitclass
from numba.typed import List as NumbaList
from typing import List
from collections import OrderedDict
from PqueueNumba import CreatePriorityQueue,PQVector
import random
@njit
def CreatePermutation(ls1):
    repeated = []
...
kv_ty = (types.int64, types.ListType(types.int64))
specB = OrderedDict()
...
CreatePoblation(1,NumbaList([1,1,1]))