...
from BPnumba.GeneticOperators import RouletteWheel, ind_type
...
class DABC:
    def __init__(self, pop_num: int, n: int):
        ...
        self.n = n #Numero de cajas = max numero entero de ID de caja
    ...
    def ImproveFlower(self,i:int,ColonyWorker:List[Ind],datos,contenedor):
        b2gen = ImproveB(i, ColonyWorker, self.n)
    ...
    def OnlookerPhase(self,ColonyWorker,datos,contenedor):
        for _ in np.arange(len(ColonyWorker)):
